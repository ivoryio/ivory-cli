...
git push --set-upstream origin master`
      ...
      function updateConfig (repositorySshUrl) {
        return Observable.create(observer => {
          const type = isServiceComponent() ? 'service' : component.current
          config.components.push({
            name: component.current,
            type,
            repositorySshUrl
          })
        ...
        function isServiceComponent () {
          const path = `${shell.pwd()}/services/${component.current}`
